...
sap.ui.define([
    ...
    return BaseController.extend("com.sap.bpm.DocumentCentricTaskUI.controller.App", {
        ...
        getUsersAdd: function (processContext, taskId, approvalStatus, iteration) {
            ...
            var sUrl = this._getSCIMBaseURL()+"/service/scim/Users?startIndex=" + startIndex;
            var oSettings = {
                "url": sUrl,
                "method": "GET",
                "async": false
            ...
            $.ajax({
                ...
                success: function (result, xhr, data) {
                    ...
                    $.ajax({
                        ...
                        url: workflowBaseurl+"/workflow-instances/" + workflowInstanceId + "/context",
                        method: "PATCH",
                        contentType: "application/json",
                        // pass the updated context to the API
                        data: JSON.stringify(oBasicData),
        ...
        loadAttachments: function () {
            ...
            var sUrl = docServieBaseUrl+"/WorkflowManagement/DocumentCentricApprovalProcess/"
        ...
        formatDownloadUrl: function (objectId) {
           var docServieBaseUrl = this._getDocServiceRuntimeBaseURL();
            return docServieBaseUrl+"/WorkflowManagement/DocumentCentricApprovalProcess/"
